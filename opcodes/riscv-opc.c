...
{"cv.srl.sci.h",          0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_SRL_SCI_H, MASK_CV_SRL_SCI_H, match_opcode, 0},
{"cv.srl.sci.b",          0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_SRL_SCI_B, MASK_CV_SRL_SCI_B, match_opcode, 0},
...
{"cv.sra.sci.h",          0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_SRA_SCI_H, MASK_CV_SRA_SCI_H, match_opcode, 0},
{"cv.sra.sci.b",          0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_SRA_SCI_B, MASK_CV_SRA_SCI_B, match_opcode, 0},
...
{"cv.sll.sci.h",          0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_SLL_SCI_H, MASK_CV_SLL_SCI_H, match_opcode, 0},
{"cv.sll.sci.b",          0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_SLL_SCI_B, MASK_CV_SLL_SCI_B, match_opcode, 0},
...
{"cv.extract.h",          0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_EXTRACT_H, MASK_CV_EXTRACT_H, match_opcode, 0},
{"cv.extract.b",          0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_EXTRACT_B, MASK_CV_EXTRACT_B, match_opcode, 0},
{"cv.extractu.h",         0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_EXTRACTU_H, MASK_CV_EXTRACTU_H, match_opcode, 0},
{"cv.extractu.b",         0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_EXTRACTU_B, MASK_CV_EXTRACTU_B, match_opcode, 0},
{"cv.insert.h",           0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_INSERT_H, MASK_CV_INSERT_H, match_opcode, 0},
{"cv.insert.b",           0, INSN_CLASS_XCVSIMD, "d,s,b8", MATCH_CV_INSERT_B, MASK_CV_INSERT_B, match_opcode, 0},
